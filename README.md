# Project 5 - *ti's twitter*

**ti's twitter** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
GIF created with [Giphy](https://media.giphy.com/media/cYkg1gJ8Z51QTODuUa/giphy.gif).
...
1.Personalized formatting
2.Fetching info from internet

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://media.giphy.com/media/5ic8auuIMDTvNEzs7h/giphy.gif' />
